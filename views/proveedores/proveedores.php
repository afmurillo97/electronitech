...
<head>
	...
	<!-- END HEAD -->
	<script src="proveedoresUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						...
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear proveedores').'>
							...
							<div class="card">
								<div class="card-body">
									...
									<?php
										...
										if (getProveedores($inicial, $cantPagina)) {
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="proveedores.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN PROVEEDORES CREADOS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'proveedoresUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'proveedoresUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
