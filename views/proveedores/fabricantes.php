<?php
	if (!$_REQUEST) {
		header('Location:fabricantes.php?pagina=1');
	}
...
<head>
	...
	<!-- END HEAD -->
	<script src="fabricantesUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						...
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear fabricantes').'>
						...
						<div class="col-xl-12 col-sm-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<?php
										include '../../controllers/fabricantesController.php';
										...
										if (getFabricantes($inicial, $cantPagina)) {
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="fabricantes.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN FABRICANTES CREADOS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'fabricantesUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'fabricantesUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
