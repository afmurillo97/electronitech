<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="newModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-tipoVariables">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Crear Tipo de Variables</h5>
			...
			<div class="modal-body">
				<form class="forms-sample">
					...
					<button type="button" class="btn btn-primary mr-2" id="nuevoTipoVariable" data-dismiss="modal">Guardar</button>
