			...
			<div class="modal-body">
				<form class="forms-sample">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="unidadTexto" placeholder="Unidad en Texto">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">Unidad Signo</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="unidadSigno" placeholder="Unidad en Signo">
						</div>
					</div>
					<div class="form-group row">
					...
					<button type="button" class="btn btn-primary mr-2" id="nuevaVariable" data-dismiss="modal">Guardar</button>
