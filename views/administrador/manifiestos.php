<?php
	if (!$_REQUEST) {
		header('Location:manifiestos.php?pagina=1');
	}
...
<head>
	...
	<title>Manifiestos de Importación</title>
	<!-- HEAD -->
	<?php include_once '../layouts/head.php'; ?>
	<!-- END HEAD -->
	<script src="manifiestosUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">Manifiestos de Importación</h3>
						<nav aria-label="breadcrumb">
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear manifiestos').'>
							...
							<div class="card">
								<div class="card-body">
									<form class="nav-link" id="buscar" action="#" method="POST">
										...
										<input type="text" id="entrada" name="termino" class="form-control" placeholder="Ingrese Manifiesto">
									</form>

									<div id="resultado" class="table-responsive">
									<?php
										include '../../controllers/manifiestosController.php';
										...
										if (getManifiestos($inicial, $cantPagina)) {
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="manifiestos.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN MANIFIESTOS CREADOS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'manifiestosUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'manifiestosUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
