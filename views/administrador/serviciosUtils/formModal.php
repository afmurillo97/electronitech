<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="newModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-servicios">
			...
			<div class="modal-body">
				<form class="forms-sample">
					...
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">GrupoServicio</label>
						<div class="col-sm-9">
					...
					<button type="button" class="btn btn-primary mr-2" id="nuevoServicio" data-dismiss="modal">Guardar</button>
