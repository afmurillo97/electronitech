<?php
	if (!$_REQUEST) {
		header('Location:marcas.php?pagina=1');
	}
...
<head>
	...
	<!-- END HEAD -->
	<script src="marcasUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						...
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear marcas').'>
							...
							<div class="card">
								<div class="card-body">
									<form class="nav-link" id="buscar" action="#" method="POST">
										...
										<input type="text" id="entrada" name="termino" class="form-control" placeholder="Ingrese Marca">
									</form>

									<div id="resultado" class="table-responsive">
									<?php
										include '../../controllers/marcasController.php';
										...
										if (getMarcas($inicial, $cantPagina)) {
											...
											echo '
												<table class="table table-hover sort">
													<thead>
														<tr>
															<th colspan="4"><label style="font-size: 20px;">'.$totalActivos.' Marcas creadas </label></th>
														</tr>
														<tr>
															<th>Nombre</th>
															<th>Descripción</th>
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="marcas.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN MARCAS CREADAS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'marcasUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'marcasUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
