...
<head>
	...
	<!-- END HEAD -->
	<script src="categoriasUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						...
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear categorias').'>
							...
							<div class="card">
								<div class="card-body">
									<form class="nav-link" id="buscar" action="#" method="POST">
										...
										<input type="text" id="entrada" name="termino" class="form-control" placeholder="Ingrese Categoria">
									</form>
									...
									<?php
										...
										if (getCategorias($inicial, $cantPagina)) {
											...
											echo '
												<table class="table table-hover sort">
													<thead>
														<tr>
															<th colspan="4"><label style="font-size: 20px;">'.$totalActivos.' Categorias creadas </label></th>
														</tr>
														<tr>
															<th>Nivel</th>
															<th>Descripcion</th>
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="categorias.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN CATEGORIAS CREADAS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'categoriasUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'categoriasUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
