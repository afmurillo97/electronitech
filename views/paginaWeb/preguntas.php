<?php
	if (!$_REQUEST) {
		header('Location:preguntas.php?pagina=1');
	}
...
<head>
	...
	<!-- END HEAD -->
	<script src="preguntasUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						...
						<?php
							echo '
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" '.permisosItem($_SESSION['idUsuario'], 'crear preguntas').'>
							...
							<div class="card">
								<div class="card-body">
									<form class="nav-link" id="buscar" action="#" method="POST">
										...
										<input type="text" id="entrada" name="termino" class="form-control" placeholder="Ingrese Pregunta Frecuente">
									</form>

									<div id="resultado" class="table-responsive">
									<?php
										include '../../controllers/preguntasController.php';
										...
										if (getPreguntas($inicial, $cantPagina)) {
											...
											foreach (getPreguntas($inicial, $cantPagina) as $fila) {
												echo '
													<tr>
											...
											for ($i=1; $i<=$paginas; $i++) {
												...
												echo '<li class="page-item '.$active.'"><a class="page-link" href="preguntas.php?pagina='.$i.'">'.$i.'</a></li>';
											}
											echo '
													</ul>
												</nav>
											...
											echo '<br>NO EXISTEN PREGUNTAS CREADAS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'preguntasUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'preguntasUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
