...
<head>
	...
	<title>Datos de los Contactos</title>
	<!-- HEAD -->
	<?php include_once '../layouts/head.php'; ?>
	<!-- END HEAD -->
	<script src="contactosUtils/functions.js"></script>
</head>
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">Lista de Contactos</h3>
			  		</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-body">
									<form class="nav-link" id="buscar" action="#" method="POST">
										...
										<input type="text" id="entrada" name="termino" class="form-control" placeholder="Ingrese datos del Contacto">
									</form>
									...
									<?php
										...
										if (getContactos($inicial, $cantPagina)) {
											...
											echo '<br>NO EXISTEN CONTACTOS CREADOS';
										}
									?>
									</div>
								</div>
				...
				<!-- MODAL -->
				<?php include_once 'contactosUtils/formModal.php'; ?>
				<!-- MODAL -->

				<!-- MODAL NOTIFY -->
				<?php include_once 'contactosUtils/modalNotify.php'; ?>
				<!-- END MODAL NOTIFY -->
